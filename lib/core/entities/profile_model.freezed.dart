...
abstract class $UserProfileCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, int phone});
}
...
class _$_UserProfile implements _UserProfile {
  const _$_UserProfile({required this.name, required this.phone});
...
abstract class _UserProfile implements UserProfile {
  const factory _UserProfile(
      {required final String name, required final int phone}) = _$_UserProfile;
